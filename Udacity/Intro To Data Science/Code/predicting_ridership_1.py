...
def predictions(dataframe):
    ...
    return predictions, values, dataframe


def show_plots(dataframe, predictions, values):
    slope, intercept = np.polyfit(dataframe['ENTRIESn_hourly'], predictions, 1)
    plt.figure()
    
    line = slope*values+intercept
